      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
        ...
        <form onSubmit={handleSubmit}>
            <div className="my-5">
              ...
              <input 
                className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" type="email" placeholder="Email de Registro"
                value={email}
                onChange={e=> setEmail(e.target.value)}
              />
            </div>
            <input type="submit" value="Enviar Instrucciones" className="bg-indigo-700 w-full py-3 p-10 rounded-xl text-white uppercase font-bold my-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto" name="" id="" />
        </form>
