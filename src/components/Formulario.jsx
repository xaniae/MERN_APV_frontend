...
const Formulario = () => {
    ...
    //para comprobar si alguien dio click al boton de editar
    //pasando una dependencia "[paciente]" observa por los cambio sque puedan suceder en ese state
    useEffect(() => {
        if(paciente?.nombre){
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} action="" className="bg-white py-10 px-5 mb-10 lg:mb-0 shadow-md rounded-md">
                <div className="mb-5">
