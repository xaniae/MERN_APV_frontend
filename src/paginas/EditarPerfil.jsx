            ...
            <div className="flex justify-center">
                <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="submit" value="Guardar Cambios" className="bg-indigo-600 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5 cursor-pointer hover:bg-indigo-700 transition-colors" />
                    </form>
                </div>
            </div>
        </>
